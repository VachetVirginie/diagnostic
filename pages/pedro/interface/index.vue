...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="sm:text-3xl text-2xl text-indigo-500 tracking-widest font-medium title-font mb-1">Probleme interface.</h2>
    </div>
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          <div class="flex items-center mb-3">
            ...
            <h2 class="text-gray-900 text-lg title-font font-medium">Page blanche.</h2>
          </div>
          <div class="flex-grow">
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          <div class="flex items-center mb-3">
            ...
            <h2 class="text-gray-900 text-lg title-font font-medium">But non valide</h2>
          </div>
          <div class="flex-grow">
